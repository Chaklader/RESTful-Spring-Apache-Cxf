...
public interface IWalletService {
    ...
    // curl -H "Content-Type: applic ation/json" -X POST http://localhost:8080/rest/wallet/receiving/store/1 | json
    @POST
    ...
    // curl -X GET http://localhost:8080/rest/wallet/receiving/1 | json
    @GET
    @Path("receiving/{walletId:[\\d]+}")
    @Produces(MediaType.APPLICATION_JSON)
